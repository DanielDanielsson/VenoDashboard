...
export default function AboutPage() {
  return (
    <div className="section-stack">
      ...
      <div className="mx-auto w-full max-w-2xl flex flex-col gap-10 [&>p]:text-[1.0625rem] [&>p]:md:text-[1.125rem]">
      ...
      <div className="max-md:-mx-7 overflow-hidden md:mx-auto md:w-full md:max-w-2xl md:rounded-[var(--radius-lg)] md:border border-(--border)">
        <BunnyImage
          imageName="cv1.jpg"
      ...
      <div className="mx-auto w-full max-w-2xl flex flex-col gap-3 pb-32 [&>p]:text-[1.0625rem] [&>p]:md:text-[1.125rem]">
